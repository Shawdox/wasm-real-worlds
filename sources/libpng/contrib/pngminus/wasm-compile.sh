...
$CC -O0 -g pnm2png.c ../../png.c ../../pngread.c ../../pngwrite.c ../../pngtrans.c ../../pngset.c ../../pngwutil.c ../../pngwio.c ../../pngrutil.c ../../pngwtran.c ../../pngrio.c ../../pngerror.c ../../pngrtran.c ../../pngmem.c ../../pngget.c  -o pnm2png.wasm -I ../../ -I zlib/ -Lzlib -lm -lz
